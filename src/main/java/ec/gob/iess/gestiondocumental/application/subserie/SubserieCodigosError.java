package ec.gob.iess.gestiondocumental.application.subserie;

/**
 * Códigos de error estables para subseries documentales (API / Fase 4).
 */
public final class SubserieCodigosError {

...
/**
 * Códigos de error estables para series documentales (API / Fase 4).
 */
public final class SerieCodigosError {
    ...
    public static final String SER_USUARIO_NO_AUTORIZADO = "SER_USUARIO_NO_AUTORIZADO";

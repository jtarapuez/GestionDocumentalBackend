...
/**
 * Entidad JPA que representa la tabla GDOC_SERIES_T
 * Series documentales del sistema de gestión documental
 */
@Entity
@Table(name = "GDOC_SERIES_T", schema = "DOCUMENTAL_OWNER")
public class SerieDocumental {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "serie_seq")
    @SequenceGenerator(name = "serie_seq", sequenceName = "GDOC_SERIES_S", allocationSize = 1)
    @Column(name = "ID_SERIE")
    private Long id;

    @Column(name = "NOM_SERIES", length = 120)
    private String nombreSerie;

    @Column(name = "DESCR_SERIE", length = 250)

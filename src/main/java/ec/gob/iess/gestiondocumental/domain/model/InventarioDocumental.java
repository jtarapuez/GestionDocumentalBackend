...
/**
 * Entidad de dominio: Inventario documental. Sin JPA (PAS-GUI-047).
 */
public class InventarioDocumental {
    ...
    public void setDescripcionSerie(String descripcionSerie) { this.descripcionSerie = descripcionSerie; }
    public Integer getNumeroExtremoDesde() { return numeroExtremoDesde; }
    public void setNumeroExtremoDesde(Integer numeroExtremoDesde) { this.numeroExtremoDesde = numeroExtremoDesde; }
    public Integer getNumeroExtremoHasta() { return numeroExtremoHasta; }
    public void setNumeroExtremoHasta(Integer numeroExtremoHasta) { this.numeroExtremoHasta = numeroExtremoHasta; }
    public LocalDate getFechaDesde() { return fechaDesde; }
    public void setFechaDesde(LocalDate fechaDesde) { this.fechaDesde = fechaDesde; }
    public LocalDate getFechaHasta() { return fechaHasta; }
    public void setFechaHasta(LocalDate fechaHasta) { this.fechaHasta = fechaHasta; }
    public Integer getCantidadFojas() { return cantidadFojas; }
    public void setCantidadFojas(Integer cantidadFojas) { this.cantidadFojas = cantidadFojas; }
    ...
    public void setNumeroContenedor(Integer numeroContenedor) { this.numeroContenedor = numeroContenedor; }
    ...
    public void setPosicionPasivo(String posicionPasivo) { this.posicionPasivo = posicionPasivo; }
    public Integer getNumeroRac() { return numeroRac; }
    public void setNumeroRac(Integer numeroRac) { this.numeroRac = numeroRac; }
    ...
    public void setNumeroPosicion(Integer numeroPosicion) { this.numeroPosicion = numeroPosicion; }
    ...
    public void setCedulaUsuarioCambio(String cedulaUsuarioCambio) { this.cedulaUsuarioCambio = cedulaUsuarioCambio; }
    ...
    public void setIdSubserie(Long idSubserie) { this.idSubserie = idSubserie; }

...
/**
 * Entidad JPA para la tabla GDOC_CATALOGOSDET_T.
 * Solo usada en infraestructura; el dominio usa {@link ec.gob.iess.gestiondocumental.domain.model.CatalogoDetalle}.
 */
@Entity
@Table(name = "GDOC_CATALOGOSDET_T", schema = "DOCUMENTAL_OWNER")
public class CatalogoDetalleEntity {
    ...
    public CatalogoEntity getCatalogo() { return catalogo; }
    public void setCatalogo(CatalogoEntity catalogo) { this.catalogo = catalogo; }
